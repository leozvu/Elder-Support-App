-- Fix demo users with correct credentials
...
VALUES
  ('00000000-0000-0000-0000-000000000011', 'martha@example.com', 'Martha Johnson', 'customer', now(), now(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=Martha'),
  ('00000000-0000-0000-0000-000000000012', 'helper@example.com', 'Helper User', 'helper', now(), now(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=Helper'),
  ('00000000-0000-0000-0000-000000000013', 'admin@example.com', 'Admin User', 'admin', now(), now(), 'https://api.dicebear.com/7.x/avataaars/svg?seed=Admin')
...
VALUES
  ('00000000-0000-0000-0000-000000000012', 'Experienced helper ready to assist seniors', 'verified', '{"companionship","shopping","transportation"}', now(), now())
